...
public class MyURLClassLoader extends SecureClassLoader {
	...
	public MyURLClassLoader(URL[] urls, ClassLoader parent,
		...
		ucp = new MyURLClassPath(urls, factory);
		acc = AccessController.getContext();
	}
	...
	protected PermissionCollection getPermissions(CodeSource codesource)
	{
		...
		//	MyURLClassPath.disableUrlConnectionCaching(urlConnection);
	...
	/**
	 * Force the disabling of <code>URLConnection</code> object caching.
	 * <p>
	 *  NOTE: This prevents <code>URLConnection</code> caching from preventing
	 *        <code>URLClassPath</code> objects from being garbage-collected.
	 *        Without this, each classpath (JAR) file remains locked indefinitely
	 *        because the <code>URLConnection</code> pointing to it is still "open".
	 * </p>
	 * <p>
	 *  NOTE: This method was added after overriding <code>java.net.URLClassLoader</code>.
	 * </p>
	 * 
	 * @param uc URLConnection.
	 * @author James P. Taylor
	 */
	public static void disableUrlConnectionCaching(URLConnection uc) {
		if (uc != null) {
